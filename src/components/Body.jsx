...
const boxStyle =
  "lg:text-lg md:text-base text-xs rounded-xl font-semibold lg:m-0 md:m-0 mx-4 lg:pb-12 md:pb-5 lg:px-12 md:px-5 p-3 shadow-white shadow-sm hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-103";
